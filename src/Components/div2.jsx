...
import bgDiv from "../images/bgDiv.svg";

export default function Div2() {
  return (
    <div className="flex flex-row font-rubik mt-10">
      <div
        className="w-3/4"
        style={{
      ...
      <div className="w-1/2 pb-40">
        ...
        <h1 className="mt-36  text-btnEnd w-[400px] text-[24px] font-normal">
        ...
        {/* <p className="mt-4 w-[555px] text-[18px] font-normal text-div2txtClr">
          Only verified companies can use ViH. Deliver secure experiences with
        </p> */}
        ...
        <img src={btDesign} className="absolute mt-5 ml-36"></img>
