...
import boyAnimie from "../images/boyAnimie.svg";
import star from "../images/star.png";
import btDesign from "../images/design.svg";
        ...
        <div className="flex flex-row gap-10">
          <div className="w-2/3 mt-24 ">
            <div className="ml-10 font-rubik">
              ...
              <img src={btDesign} className="absolute mt-[22rem] ml-48"></img>
              <button className="cursor-pointer absolute ml-2 mt-96 bg-gradient-to-r from-btnStrt to-btnEnd px-[24px] py-[14px] text-white font-rubik shadow-md rounded-lg">
                <span className="h-10 m-4 mt-6">Book A Demo</span>
              </button>
            </div>
          </div>
          <div className="w-2/3 ml-20 pl-28">
            <img src={boyAnimie} className="max-w-min ml-4"></img>
          </div>
        </div>
      </div>
